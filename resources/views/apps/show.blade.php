        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="accordion accordion-flush mb-4" id="basic">
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#show-basic">
                                基本設定
                            </button>
                        </h2>
                        <div id="show-basic" class="collapse show">
                            <div class="mb-3 row">
                                ...
                                <label class="col-sm-10 col-form-label">{{ $chart["chart_name"] }}</label>
                            </div>
                            <div class="mb-3 row">
                                <label class="col-sm-2 col-form-label">運作狀態</label>
                                <label class="col-sm-10 col-form-label"><span class="badge badge-success">運行中</span></label>
                            </div>
                            <div class="mb-3 row">
                                <label class="col-sm-2 col-form-label">服務名稱</label>
                                <label class="col-sm-10 col-form-label">{{ $chart["name"] }}</label>
                            </div>
                            <div class="mb-3 row">
                                <label class="col-sm-2 col-form-label">網域名稱</label>
                                <label class="col-sm-10 col-form-label">{{ $chart["config"]["ingress"]["hostname"] }}</label>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion accordion-flush mb-4" id="monitor">
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#show-monitor">
                                資源監控
                            </button>
                        </h2>
                ...
                <div class="accordion accordion-flush mb-4" id="event">
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#show-event">
                                容器事件
                            </button>
                        </h2>
                            ...
                            <table class="table">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col"><a class="btn btn-light">事件原因<i class="ms-3 fas fa-sort"></i></a></th>
                                        <th scope="col"><a class="btn btn-light">事件訊息<i class="ms-3 fas fa-sort"></i></a></th>
                                        <th scope="col"><a class="btn btn-light">最後更新<i class="ms-3 fas fa-sort"></i></a></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                ...
                <div class="accordion accordion-flush mb-4" id="console">
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#show-console">
                                Console
                            </button>
                        </h2>
                ...
                <div class="accordion accordion-flush mb-4" id="env">
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#show-env">
                                環境變數
                            </button>
                        </h2>
                ...
                <div class="accordion accordion-flush mb-4" id="database">
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#show-database">
                                資料庫
                            </button>
                        </h2>
